  ...
  const inputWrapper = "relative flex items-center gap-3 border-2 border-gray-200 bg-white/80 backdrop-blur-sm rounded-xl px-4 py-3 mb-6 shadow-lg focus-within:ring-4 focus-within:ring-blue-500/20 focus-within:border-blue-500 transition-all duration-300 hover:shadow-xl";
    ...
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <svg className="absolute top-0 left-0 w-full h-full" viewBox="0 0 1200 800" preserveAspectRatio="none">
          ...
          {/* Animated Waves */}
          <path d="M0,400 Q300,200 600,400 T1200,400 V800 H0 Z" fill="url(#grad1)" className="animate-pulse">
            <animateTransform
          ...
          <path d="M0,500 Q400,300 800,500 T1200,500 V800 H0 Z" fill="url(#grad2)" className="animate-pulse delay-1000">
            <animateTransform
              attributeName="transform"
              type="translate"
              values="0,0;-30,0;0,0"
          ...
          {/* Floating Geometric Shapes */}
          <circle cx="100" cy="100" r="40" fill="rgba(59, 130, 246, 0.1)" className="animate-bounce">
            <animateTransform
              attributeName="transform"
              type="translate"
          ...
          <polygon points="1000,150 1050,200 1000,250 950,200" fill="rgba(139, 92, 246, 0.1)" className="animate-spin" style={{transformOrigin: '1000px 200px'}}>
            <animateTransform
              attributeName="transform"
              type="rotate"
          ...
          <rect x="200" y="600" width="60" height="60" fill="rgba(6, 182, 212, 0.1)" className="animate-pulse">
            <animateTransform
              attributeName="transform"
              type="rotate"
      ...
      <div className="relative z-10 w-full max-w-md mx-4 sm:mx-0">
        <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300 text-sm sm:text-base">Welcome back! Please sign in to your account</p>
          </div>
