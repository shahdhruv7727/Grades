      ...
      <Controller
        ...
        render={({ field }) => (
          <div className={`flex items-center gap-3 border-2 ${
            ...
            {prefix && (
              <span className="text-gray-500 border-r border-gray-200 pr-3">{prefix}</span>
            )}
            <input
              {...field}
              type={type}
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8 rounded-2xl">
              ...
              <p className="text-gray-500 text-sm mt-1">Let's start with basic details</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-1">Educational information</p>
            </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-1">Where can we reach you?</p>
            </div>
